...
export const BirthdayQuiz = () => {
  ...
  const questions: Question[] = useMemo(() => {
    const base: Question[] = [
      ...
      {
        q: `فاكرة أول يوم قابلتك؟`,
        options: ["10/9", "13/9", "15/9", "20/9"],
        correct: 1,
        reason: `13/9... اليوم اللي حياتي اتغيرت فيه.`
      },
      {
        q: `أول مادة شفتك فيها؟`,
        options: ["عربي", "كيميا", "إنجليزي", "فرنساوي"],
        correct: 1,
        reason: `درس الكيميا.. ومن يومها وأنا بتعلم الحب منك!`
      },
      {
        q: `مين أم أولادي في المستقبل؟`,
        options: ["رندا", "رورو", "أم ليلى", "كل ما سبق"],
        correct: 3,
        reason: `رندا طبعاً، ربنا يبارك لي فيكي يا رب.`
      }
    ];
